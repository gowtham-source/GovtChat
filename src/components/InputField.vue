...
const iconname = computed(() => {
  ...
  } else if (props.label.toLowerCase() === "phone") {
    return "call-outline";
  } else if (props.label.toLowerCase() === "name") {
    return "person-outline";
  } else if (props.label.toLowerCase() === "age") {
    return "calendar-outline";
  } else if (props.label.toLowerCase() === "religion") {
    return "people-outline";
  } else if (props.label.toLowerCase() === "caste") {
    return "people-outline";
  } else if (
    props.label.toLowerCase() === "city" ||
    props.label.toLowerCase() === "state"
  ) {
